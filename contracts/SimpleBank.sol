...
contract SimpleBank {
    ...
    event LogEnrolled(address _addr);
    ...
    function getBalance() public view returns (uint) {
      ...
      require(enrolled[msg.sender], "The account is not enrolled");
    ...
    function withdraw(uint withdrawAmount) public returns (uint) {
      ...
      require(curBalance >= withdrawAmount, "Insufficient funds.");
      ...
      require(success, "Could not complete withdrawal");

      // 3. Emit the appropriate event for this message
      emit LogWithdrawal(msg.sender, withdrawAmount, curBalance);
